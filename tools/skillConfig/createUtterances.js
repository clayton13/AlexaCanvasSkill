...
var utterances = [
    ...
    "",
    "GetGradeIntent ( |what is|what's|get|tell me|tell me about|about) my (|current) grade (in|for)  {ClassName} (|class)",
    "GetGradeIntent ( |what is|what's|get|tell me|tell me about|about) my (|current) {ClassName} (|class) grade",
    ...
    "GetGradeIntent ( |get|tell me|tell me about|about) ( |what) my (|current) grade (in|for)  {ClassName} (|class) (|is)",
